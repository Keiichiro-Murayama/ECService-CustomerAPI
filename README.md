...
| 4   | ログイン顧客アカウント情報取得API | GET      | /api/customer/profile                | 購入確認画面 (FP009)              | 必須 |
...
ログイン顧客アカウントの過去の注文履歴一覧 (FP011) を取得します。注文日時の新しい順（降順）で返却されます。
